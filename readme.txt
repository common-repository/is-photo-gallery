...
Tags: picture, pictures, gallery, galleries, coverflow, flow, image, images, flow, lightbox, carousel, autorotate, automatic, rotate, media, tages
...
Display images on the current page or post using the basic JQuery library.

There are three ways to insert a IS Photo Gallery:

1. Select the images attached to your post/page with the shortcode [wp-is3dphoto]
2. Upload your pictures to a subfolder and use the shortcode [wp-is3dphoto dir=SUBFOLDER]
3. Tag images in your media library using the Media Tags plugin by Paul Menard and use the shortcode [wp-is3dphoto mediatag=tagslug]
...
3. Configure the gallery in Settings -> IS Photo Gallery.
...
2. Use the shortcode [wp-is3dphoto] anywhere in the post or page
...
4. Insert a gallery on a page by specifying the shortcode [wp-is3dphoto dir=subfolder] on your post or page.
...
1. IS Photo Gallery, captions enabled
2. IS Photo Gallery, captions disabled
